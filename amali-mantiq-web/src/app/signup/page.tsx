        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
            ...
            <div className="relative w-full max-w-md">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold text-white">Join Eqaz</h1>
                    <p className="text-slate-400 mt-2">Create your student account</p>
                </div>

                <form onSubmit={handleSubmit} className="bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 space-y-5 shadow-2xl">
